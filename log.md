...
### Day 50: June 5, Monday

**Today's Progress**: Do intermidate challeges of freecodecamp (roman number)
**Thoughts** So tired today, but i did a lot of things.
...
**Today's Progress**: Start doing my podomo clock challege
...
### Day 75: July 22, Saturday

**Today's Progress**: make the bubble get filled little by little in a minute, but don't know how i can add text inside it yet
**Thoughts** Have a lot to learn.
...
**Today's Progress**: Using gradient to fill the bubble when time increased and it also look nicer. But somehow the code doesn't run
**Thoughts** Bug makes me tired.

**Link(s) to work** https://codepen.io/Anhtu07/pen/RgYMXV
1. https://codepen.io/Anhtu07/pen/GEQPZR


### Day 77: July 24, Monday
